        ...
        <section>
          ...
          <ul className="post">
            <li style={{ padding: "10px 0" }}>
              ...
              <h1 class="cp_point" style={{ padding: "5px" }}>3密回避で安心・安全</h1>
              <h1 class="cp_point" style={{ padding: "5px" }}>ご来店できない時に便利</h1>
              <h1 class="cp_point" style={{ padding: "5px" }}>いつでも閲覧可</h1>
              <h1 class="cp_point" style={{ padding: "5px" }}>無料</h1>

              　以下の登録ボタンより、「南郷7丁目チャンネル」<br/>
              　にアクセスできます。<br/>
              <br/>

              <a href="https://www.youtube.com/channel/UCJqq9wYdNCzzuRvAeI_Op7Q/?sub_confirmation=1" class="qa_button" target="_blank" rel="noopener noreferrer">
              ...
              <div class="yb_nango_info">
                <div class="yb_nango_inner_mv">
            ...
            <li>
              ...
              <h1 class="cp_sv" style={{ padding: "5px" }}>オンライン配信サービス<br/>（4カメご用意しております）</h1>
              <h1 class="cp_sv" style={{ padding: "5px" }}>動画収録及びメディア作成</h1>
              <img src="/static/hp_nango/images/youtube_live.png" style={{float: "none", margin: "0px", width: "80%"}}/>
              <br/><br/>
              
              　活用シーンも様々ですので是非ご利用ください。<br/>
              <h1 class="cp_seen" style={{ padding: "5px" }}>ライブイベント等の配信<br/>(YouTube、Facebook)</h1>
              <h1 class="cp_seen" style={{ padding: "5px" }}>SNSの動画投稿用<br/>(Twitter、 Facebook、Instagram)</h1>
